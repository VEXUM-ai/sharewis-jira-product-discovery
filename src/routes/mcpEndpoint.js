...
/**
 * MCP Server Setup for HTTP/SSE Transport
 */
...
/**
 * MCP tools list endpoint (GET /mcp/tools)
 */
export function handleMCPToolsList(req, res) {
  res.json({
    tools: [
      {
        name: 'analyze_jira_tickets',
...
/**
 * MCP tool execution endpoint (POST /mcp/call)
 */
export async function handleMCPToolCall(req, res) {
