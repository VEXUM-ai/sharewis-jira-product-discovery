...
import { handleChatGPTMCP, handleChatGPTMCPGet } from './routes/chatgptMcp.js';
...
// ChatGPT MCP endpoint (primary endpoint for ChatGPT integration)
app.get('/mcp', handleChatGPTMCPGet);
